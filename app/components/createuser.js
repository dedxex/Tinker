System.register(['angular2/core', 'angular2/common', './services/users.service', 'angular2/http', 'angular2/router'], function(exports_1, context_1) {
    ...
    var core_1, common_1, users_service_1, http_1, router_1;
    var CreateUser;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            CreateUser = (function () {
                function CreateUser(fb, _router, _usersService, _routeParams) {
                ...
                CreateUser.prototype.routerCanDeactivate = function () {
